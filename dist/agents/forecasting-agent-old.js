...
class ForecastingAgent {
    constructor(config) {
        ...
        this.provider = new ethers_1.ethers.JsonRpcProvider(config.arbitrumRpcUrl);
...
- Only recommend BUY/SELL if confidence > 65%`;
    ...
    async attestForecast(forecast) {
        try {
            ...
            const easContract = new ethers_1.ethers.Contract(this.easContractAddress, easABI, this.signer);
...
//# sourceMappingURL=forecasting-agent-old.js.map