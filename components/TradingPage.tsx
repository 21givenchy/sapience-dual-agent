      ...
      <div className="flex flex-col items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-gray-400 mb-8 max-w-md">
            Connect your wallet to start making predictions on Sapience markets with your own account
          </p>
          <WalletConnect />
        </div>
      </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold text-white">Trade with Your Wallet</h2>
          <p className="text-gray-400 text-sm">Submit predictions directly from your connected wallet</p>
        </div>
      ...
      {forecast && selectedCondition && (
        <div className="bg-gradient-to-br from-green-900 to-blue-900 border-2 border-green-500 rounded-lg p-6">
          <h3 className="text-xl font-bold text-white mb-4">💰 Your Forecast Ready to Submit</h3>
          ...
          <div className="flex gap-3">
            ...
            >
              {isWriting ? '📝 Signing...' : isConfirming ? '⏳ Confirming...' : '💰 Submit from Wallet'}
            </button>
            <button
              onClick={() => {
                setForecast(null)
